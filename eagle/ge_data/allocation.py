...
# Modify this if you have other gpu schemes
gpus=[[0],[1],[2],[3]]
num_p = len(gpus)
...
for i in range(num_p):
    ...
    if os.path.dirname(__file__) == '':
        ...
        command = "python {}/ge_data_all_vicuna.py --start={} --end={} --index={} --gpu_index {} --outdir {}".format(os.path.dirname(__file__), start, end, index,
                                                                                                gpu_index_str, outdir)
